...
class Amenities extends React.Component {
  constructor(props) {
    ...
    this.iconContent = {
      ...
      laptopfriendlyworkspace: 'A table or desk with space for a laptop and a chair that’s comfortable to work in',
  ...
  render() {
    ...
    return (
      <section className={css['amenities-main']}>
        ...
        >
          <button type="button" className={css['close-button']} onClick={this.handleCloseModal}>{svgButton}</button>
          <div className={css['all-amenities-main']}>
            ...
            <section>
              ...
              <div className={css['laptop-content']}>{this.iconContent.Laptopfriendlyworkspace}</div>
              <hr />
